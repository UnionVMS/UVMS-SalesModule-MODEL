...
public class CompareReportOnCreationDateAscendingTest {

    private CompareReportOnCreationDateAscending compareReportOnCreationDateAscending;

    @Before
    public void init() {
        this.compareReportOnCreationDateAscending = new CompareReportOnCreationDateAscending(new ReportHelper());
    }
    ...
    public void compareCase1() throws Exception {
        ...
        Collections.sort(list, compareReportOnCreationDateAscending);
